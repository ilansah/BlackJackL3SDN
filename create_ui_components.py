#!/usr/bin/env python3
"""
Script pour créer une interface de paramètres interactive avec des boutons et sliders.
"""
...
def create_interactive_settings():
    """Crée les fonctions pour l'interface interactive des paramètres"""
...
'''
    ...
    output_path = os.path.join(BASE_DIR, "src", "settings_ui.py")
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(settings_ui_code)
    
    print(f"✓ Créé {output_path}")
    return output_path

if __name__ == "__main__":
    print("Création des composants UI pour les paramètres...")
